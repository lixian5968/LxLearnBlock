...
public class MultiImageSelectorActivity extends AppCompatActivity
    ...
    boolean cameraNoCallBack = false;
...
//        final boolean isShow= false
        cameraNoCallBack = intent.getBooleanExtra("cameraNoCallBack", false);
    ...
    public void onCameraShot(File imageFile) {
        if (imageFile != null) {
            ...
            showMyWaitDialog(MultiImageSelectorActivity.this);
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(MultiImageSelectorActivity.this, "更新完成，如果图片错误，请重新选择", Toast.LENGTH_SHORT).show();
                    CancelWaitDialog();
                }
            }, 800);
    ...
    // 等待对话框
    public AlertDialog MyWaitDialog;
    ...
    public void showMyWaitDialog(final Context ct) {
        ...
        View view = View.inflate(ct, R.layout.mis_wait_wait_dialog2, null);
        if (MyWaitDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(ct);
            builder.setView(view);
            MyWaitDialog = builder.create();
        }
